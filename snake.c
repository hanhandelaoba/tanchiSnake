    ...
    {  
        ...
        mvaddstr(1, 2, "Game: snake    version: 1.0    date: 2015/05/04");  
        mvaddstr(2, 2, "Author: Wangkai   original Blog: blog.csdn.net/jjzhoujun2010");  
        mvaddstr(3, 2, "Usage: Press 'f' to speed up, 's' to speed down,'q' to quit.");  
        mvaddstr(4, 2, "       Nagivation keys controls snake moving.");  
        refresh();  
    }  
